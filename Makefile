...
#---------------------------------------------------------------------------------
APP_VER					:= 0001
APP_TITLE				:= PETSCII Robots
APP_DESCRIPTION			:= PETSCII Robots for Nintendo 3DS
APP_AUTHOR				:= RetroGamer02
PRODUCT_CODE			:= CTR-PSR
...
LIBS	:= -lSDL2_image -lSDL2 -lSDL2main -lcitro3d -lctru -lm

#---------------------------------------------------------------------------------
# list of directories containing libraries, this must be the top level containing
# include and lib
#---------------------------------------------------------------------------------
LIBDIRS	:= $(CTRULIB) $(CURDIR)/SDL2
